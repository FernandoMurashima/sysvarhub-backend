...
SYSVARHUB_NFCE_MATERIAL_MODE = config("SYSVARHUB_NFCE_MATERIAL_MODE", default="DESENVOLVIMENTO")
SYSVARHUB_NFCE_A1_PATH = config("SYSVARHUB_NFCE_A1_PATH", default="")
SYSVARHUB_NFCE_A1_PASSWORD = config("SYSVARHUB_NFCE_A1_PASSWORD", default="")
SYSVARHUB_NFCE_SEFAZ_CLIENT = config("SYSVARHUB_NFCE_SEFAZ_CLIENT", default="DESENVOLVIMENTO")
SYSVARHUB_NFCE_SEFAZ_DESENVOLVIMENTO_RESULTADO = config(
    "SYSVARHUB_NFCE_SEFAZ_DESENVOLVIMENTO_RESULTADO",
    default="AUTORIZADA",
)
SYSVARHUB_NFCE_SEFAZ_AUTORIZACAO_URL = config("SYSVARHUB_NFCE_SEFAZ_AUTORIZACAO_URL", default="")
SYSVARHUB_NFCE_SEFAZ_CONSULTA_URL = config("SYSVARHUB_NFCE_SEFAZ_CONSULTA_URL", default="")
SYSVARHUB_NFCE_SEFAZ_EVENTO_URL = config("SYSVARHUB_NFCE_SEFAZ_EVENTO_URL", default="")
SYSVARHUB_NFCE_QRCODE_URL = config("SYSVARHUB_NFCE_QRCODE_URL", default="")
SYSVARHUB_NFCE_URL_CHAVE = config("SYSVARHUB_NFCE_URL_CHAVE", default="")
